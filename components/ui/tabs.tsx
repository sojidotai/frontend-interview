...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            'inline-flex h-10 items-center justify-center rounded-lg border border-zinc-300 px-1 text-muted-foreground',
            className,
        )}
        {...props}
    />
